                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                                <h1 class="slide-headline">Enerji <br> IoT Platformu </h1>
                                <p class="slide-desc">Farklı sektörlerden kuruluşlar, Map Enerji IoT Platformu ile enerji ve operasyonel verimliliklerini artırmayı tercih ediyor! </p>
            ...
            <div class="slide bg-overlay bg-overlay-dark-slider">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                                <h1 class="slide-headline">TARİFE DANIŞMANLIĞI</h1>
                                <p class="slide-desc">Elektrik satın alması kadar doğru tarifeden elektrik kullanmakta maliyet azaltıcı bir unsurdur. </p>
                                <div class="slide-action">
                                    <div class="slide-list">
                                        <div class="icon"> <i class="flaticon-040-green-energy"></i></div>
                                        <div class="icon"> <i class="flaticon-020-factory"></i></div>
        ...
        <div class="heading heading-2 heading-light heading-light2">
            <!-- <div class="row">
                <div class="col-12 col-lg-12">
                    <p class="heading-subtitle" style="color:#32c36c !important">Sustainable, Reliable & Affordable Energy!</p>
                </div>
            </div> -->
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h2 class="heading-title">Çözümlerimiz</h2>
                </div>
