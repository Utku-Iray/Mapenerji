            ...
            <div class="title">
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <h1 class="title-heading">Ges Arazi Satış</h1>
                    </div>
                </div>
                <!-- <div class="row">
                ...
                <div class="col-12">
                    <div class="breadcrumb-wrap">
                        <ol class="breadcrumb breadcrumb-light d-flex">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ges Arazi Satış</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="entry-stats entry-infos">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 text-auto-center">
                                    ...
                                    <p>Enerji santrali kurmak isteyen Yatırımcıların Dikkatine
